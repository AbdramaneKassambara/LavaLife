<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lireMessage.aspx.cs" Inherits="prjWebCsTransaction1.lireMessage" %>
...
<body>
    <form id="form1" runat="server">
       ...
       <table>
           <tr>
               <td>
                       <asp:Panel ID="panMess" runat="server"  Font-Bold="True" 
                        GroupingText="Message">

                   <asp:Label ID="lblMess" runat="server" Height="60px" Width="100px" ></asp:Label>
                   </asp:Panel>
               </td>
           </tr>
       </table>
