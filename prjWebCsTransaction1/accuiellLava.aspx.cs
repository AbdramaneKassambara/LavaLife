    ...
    public partial class accuiellLava : System.Web.UI.Page
    {
        ...
        private void utilisateur()
        {
            ...
            while (read.Read())
            {
                ...
                boutonMessage.Text = "<a href='MessageLava.aspx?refUtilisat=" + refuti + "' class='btn btn-danger'style='border-radius:50px;'>Envoyer un message</a>";
        ...
        protected void btnCher_Click(object sender, EventArgs e)
        {
            ...
            while (read.Read())
            {
                ...
                //if (val==Nom || val==Prenom || val==Np){
                    ...
                    if (read["Genre"].ToString().Equals("Femme"))
                    {
                        iconeGenre.Text = "<img src='image/femme.png' " +
                        "style='width:100px; height:90px;'>";
                    }
                    else
                    {
                        iconeGenre.Text = "<img src='image/homme.png' style='width:100px; height:90px;'>";
                    }
                    ligneUtilisateur.Cells.Add(iconeGenre);
