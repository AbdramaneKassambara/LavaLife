           ...
           <p id="p1">Forgot Your Password?</p>
            ...
            <table>
               ...
               <tr>
                ...
                <tr>
                   <td colspan="3"><asp:TextBox ID="txtEmail" runat="server" Height="35px" Width="400"></asp:TextBox></td>
               </tr>
                <tr><td colspan="3">
                    <asp:Label ID="lblPass1" runat="server" Text="Nouveau Password"></asp:Label></td>
                </tr>
                <tr><td>
                    <asp:TextBox ID="txtNewPass" runat="server" Height="35px" Width="400"></asp:TextBox></td></tr>
                <tr>
                   <td colspan="3">
