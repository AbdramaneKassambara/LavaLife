<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MessageLava.aspx.cs" Inherits="prjWebCsTransaction1.MessageLava" %>
   ...
   <div class="row">
      <div class="col-sm-6 ll_right_bg">
          ...
          <asp:Button ID="btnDest" runat="server" Text="Modifier Destinateur" CssClass="btnDest" Font-Italic="True" Font-Bold="True" BackColor="Red" ForeColor="White" OnClick="btnDest_Click"/></td>
                 <td> <asp:DropDownList ID="cboDes" runat="server" Width="250px" CssClass="cboDes" Font-Bold="True" Font-Italic="True" ForeColor="Red" OnSelectedIndexChanged="cboDes_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList></td>
              </tr>
               <tr> <td>
