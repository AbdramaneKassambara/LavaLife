<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LireMessageLava.aspx.cs" Inherits="prjWebCsTransaction1.LireMessageLava" %>
<!DOCTYPE html>
    ...
    <form id="form1" runat="server">
        ...
        <div class="row">
            <div class="col-sm-7 ll_let_bg">
                <h2>Discussions</h2>
                <asp:Table ID="tabMessage" runat="server" CssClass="tabMessage" Font-Bold="True" Font-Italic="True" ForeColor="Black"></asp:Table>
